...
@section('pageTitle', $customer->name . ' - ' . __('admin.menu.customer_ledger'))
...
<div class="card mb-3">
    <div class="card-body d-flex justify-content-between align-items-center">
        <div>
            ...
            <small class="text-muted">{{ $customer->customer_code }} · {{ $customer->phone }}</small>
        </div>
        <div class="text-end">
            <p class="mb-0 text-muted small">Current Balance</p>
            <h4 class="mb-0">{{ number_format((float) $customer->current_balance, 2) }}</h4>
        </div>
    </div>
</div>
