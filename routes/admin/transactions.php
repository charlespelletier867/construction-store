...
Route::resource('sale_items', App\Http\Controllers\Admin\SaleItemsController::class);
...
Route::resource('sale_return_items', App\Http\Controllers\Admin\SaleReturnItemsController::class);
Route::resource('quotations', App\Http\Controllers\Admin\QuotationsController::class);
Route::resource('quotation_items', App\Http\Controllers\Admin\QuotationItemsController::class);

Route::resource('purchase_invoices', App\Http\Controllers\Admin\PurchaseInvoicesController::class);
Route::resource('purchase_items', App\Http\Controllers\Admin\PurchaseItemsController::class);
...
Route::resource('purchase_return_items', App\Http\Controllers\Admin\PurchaseReturnItemsController::class);
